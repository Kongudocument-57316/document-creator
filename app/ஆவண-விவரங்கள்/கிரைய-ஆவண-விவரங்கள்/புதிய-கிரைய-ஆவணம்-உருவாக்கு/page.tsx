...
export default function NewSaleDocumentPage() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      router.push("/ஆவண-விவரங்கள்/கிரைய-ஆவண-விவரங்கள்")
    } catch (error) {
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="w-full md:w-1/2 space-y-4">
          ...
          <div className="space-y-4">
            <Card className={`border-l-4 ${expandedSections.basicDetails ? "border-l-cyan-500" : "border-l-gray-300"}`}>
              <div
            ...
            <Card className={`border-l-4 ${expandedSections.buyerDetails ? "border-l-cyan-500" : "border-l-gray-300"}`}>
              <div
                className="p-4 font-medium flex justify-between items-center cursor-pointer"
            ...
            >
              ...
              {expandedSections.sellerDetails && (
                <CardContent>
                  <SellerDetailsForm data={formData.sellers} updateData={(data) => updateFormData("sellers", data)} />
                </CardContent>
              )}
            </Card>
          ...
          <div className="flex space-x-4 mt-6">
            <Button variant="outline" onClick={() => router.push("/ஆவண-விவரங்கள்/கிரைய-ஆவண-விவரங்கள்")}>
              பின்செல்
            </Button>
