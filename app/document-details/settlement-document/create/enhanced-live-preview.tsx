...
import { Eye, EyeOff, HighlighterIcon, AlertCircle } from "lucide-react"
...
export function EnhancedLivePreview({ document, onHighlightField, isDirty = false }: EnhancedLivePreviewProps) {
  ...
  const getRelationshipTypeInTamil = (type: string | undefined) => {
    if (!type) return ""
  ...
  const getMonthInTamil = (month: string | undefined) => {
    if (!month) return ""
    ...
    return (
      <div className="p-6 bg-white text-black font-serif">
        <div className="text-center mb-6">
          <h1 className="text-2xl font-bold mb-2">தானசெட்டில்மெண்ட் பத���திரம்</h1>
        ...
        <div className="mb-6">
          <p className="mb-4">
            ...
            என்னுடைய ஆவலினாலும், நான் சர்வ சுதந்திரமாக அடைந்து ஆண்டனுபவித்து வருகின்ற கீழ்க்கண்ட சொத்துக்களை, நாளது தேதியேலேயே உமக்கு இந���த
    ...
    return (
      <div className="p-6 bg-white text-black font-serif">
        <div className="text-justify leading-relaxed">
          ...
          <div className="mb-4">
            இந்த தானசெட்டில்மெண்ட் பத்திரத்தை எக்காரணம் கொண்டும் ரத்��ு செய்வதில்லை என்றும், அப்படி மீறி ரத்து செய்தாலும் அது செல்லத்தக்கது அல்ல
        ...
        <div className="flex items-center gap-2">
          ...
          {lastUpdated && (
            <Badge variant="outline" className="text-xs">
              கடைசி புதுப்பிப்பு: {format(lastUpdated, "HH:mm:ss")}
            </Badge>
          )}
        </div>
              ...
              <div className="flex items-center gap-1">
                {previewMode === "final" ? (
                  ...
                  <>
                    ...
                    <span>திருத்ததிருத்த தோற்றம்</span>
                  </>
                )}
              </div>
            </Label>
