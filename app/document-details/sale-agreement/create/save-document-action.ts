...
export async function saveDocument(data: SaleAgreementData) {
  try {
    ...
    // Insert into sale_agreements table
    const { data: documentData, error: documentError } = await supabase
      ...
      .insert({
        ...
        property_details: data.properties, // Store as JSON array
      })
      .select("id")
      .single()
