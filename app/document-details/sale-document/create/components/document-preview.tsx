...
export default function DocumentPreview({ formData }) {
  ...
  return (
    <div className="space-y-6 font-tamil text-justify leading-relaxed">
        ...
        <CardContent className="p-6">
          ...
          <div className="mb-4">
            {primaryBuyer.address && (
              <p>
                ...
                மாதம்{" "}
                {formData.basicDetails.registrationDate && new Date(formData.basicDetails.registrationDate).getDate()}-ம்
                தேதியில்
                <br />
          ...
          <div className="mb-4">
            <p>
              ...
              {formatCurrencyInWords(formData.paymentDetails.totalValue)} மட்டும்) விலைக்கு பேசி கொடுப்பதாக ஒப்புக்கொண்டு மேற்படி
              கிரையத் தொகையை கீழ்க்கண்ட சாட்சிகள் முன்பாக நான் ரொக்கமாகப் பெற்றுக்கொண்டு கீழ்க்கண்ட சொத்துக்களை இன்று தங்களுக்கு சுத்தக்கிரையமும்
              சுவாதீனமும் செய்து கொடுத்திருக்கின்றேன்.
            </p>
          </div>
          ...
          <div className="mb-4">
            <p>
              ...
              {formatCurrency(formData.paymentDetails.totalValue)}/-(ரூபாய்{" "}
              {formatCurrencyInWords(formData.paymentDetails.totalValue)} மட்டும்) விலைக்கு பேசி கொடுப்பதாக ஒப்புக்கொண்டு மேற்படி
              கிரையத் தொகை எனக்கு வரவானதுக்கான விவரம்:-
              {/* Payment details would be expanded based on payment method selected */}
              கிரையம் எழுதி பெறும் {primaryBuyer.name} அவர்களின் {/* Bank details placeholder */}
              இதன் வங்கி {/* Payment method placeholder */} எண்:- {formData.paymentDetails.paymentReference} மூலம், கிரையம்
              எழுதி கொடுக்கும் {primarySeller.name} அவர்களின் பெயரில் வழங்கிய தொகை ரூ.
              ...
              {formData.paymentDetails.paymentDate && formatDate(formData.paymentDetails.paymentDate)}-ம் தேதியில் வரவாகி
              விட்டபடியால், கீழ்க்கண்ட சொத்துக்களை இன்று தங்களுக்கு சுத்தக் கிரையமும் சுவாதீனமும் செய்து கொடுத்திருக்கின்றேன்.
            </p>
          </div>
          ...
          <div className="mb-4">
            ...
            <p className="mt-2">
              ...
              மார்ட்கேஜ் முதலியவை ஏதுமிருப்பதாகத் தெரியவரும் பட்சத்தில் அவற்றை நானே முன்னின்று எனது சொந்த செலவிலும், சொந்த பொறுப்பிலும் எனது
              இதர சொத்துக்களைக் கொண்டு நானே ஜவாப்தாரியாய் இருந்து கிரைய சொத்துக்கு நஷ்டம் ஏற்படாதவாறு நானே முன்னின்று தீர்த்துக் கொடுக்க இதன் மூலம்
              உறுதி கூறுகிறேன்.
            </p>
            <p className="mt-2">
              கிரைய பத்திரத்தில் எழுதிக்கொடுப்பவருக்கு முழு உரிமையும் சுவாதீனமும் உள்ளது என எழுதிவாங்குபவருக்கு, எழுதிக்கொடுப்பவர்
              உறுதியளித்ததின் பேரிலும், எழுதிக்கொடுப்பவர் அளித்த பதிவுருக்களை எழுதிவாங்குபவர் ஆய்வு செய்து, அதன் பேரில் இந்த கிரைய ஆவணம்
              தயார் செய்யப்பட்டு எழுதிவாங்குபவர், எழுதிக்கொடுப்பவர் என இரு தரப்பினரும் படித்துப்பார்த்தும் படிக்கச்சொல்லி கேட்டும் மன நிறைவு
              அடைந்ததன் பேரிலும் இக்கிரைய ஆவணம் பதிவு செய்யப்படுகிறது.
            </p>
            <p className="mt-2">
          ...
          {formData.previousDocuments && formData.previousDocuments.length > 0 && (
            <div className="mb-4">
              <p>
                ...
                க்கு {/* Document type placeholder */} ஆவணத்தின் {/* Original/Copy placeholder */} இக்கிரைய ஆவணத்திற்கு ஆதரவாக
                தங்களுக்கு கொடுத்திருக்கின்றேன்.
              </p>
            </div>
          )}
