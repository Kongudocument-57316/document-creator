...
export function SellerTab({ data, updateData }: SellerTabProps) {
  ...
  const [sellers, setSellers] = useState<any[]>(data.length > 0 && Array.isArray(data) ? data : [createEmptySeller()])
  ...
  const removeSeller = (index: number) => {
    if (sellers.length === 1) return // Keep at least one seller
          ...
          <CardContent className="pt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Select value={seller.contactType} onValueChange={(value) => handleChange(index, "contactType", value)}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div>
                ...
                <Select value={seller.districtId} onValueChange={(value) => handleChange(index, "districtId", value)}>
                  <SelectTrigger className="mt-1 border-purple-200 focus-visible:ring-purple-400">
